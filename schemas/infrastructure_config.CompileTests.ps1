...
$invalidTestCases = @(
  ...
  @{
    Description = "missing AzDOEnvironmentName in InfrastructureConfig"
    Parameters = @{
      EnvironmentName = "dev"
      InfrastructureConfig = @{
        RunMode = "PlanOnly"
  ...
  @{
    Description = "empty AzDOEnvironmentName in InfrastructureConfig"
    Parameters = @{
      EnvironmentName = "dev"
      InfrastructureConfig = @{
        AzDOEnvironmentName = ""
  ...
  @{
    Description = "missing RunMode in InfrastructureConfig"
    Parameters = @{
      EnvironmentName = "dev"
      InfrastructureConfig = @{
        AzDOEnvironmentName = "dev-environment"
...
Run-Tests `
  -YamlPath "schemas/infrastructure_config.yml" `
