...
- **Apply with One Key Vault (KeyVaultConfigs)**: [`tests/jobs/terraform_deploy/apply_with_one_key_vault_test.yml`](../../../tests/jobs/terraform_deploy/apply_with_one_key_vault_test.yml)
- **Apply with Two Key Vaults (KeyVaultConfigs)**: [`tests/jobs/terraform_deploy/apply_with_two_key_vault_test.yml`](../../../tests/jobs/terraform_deploy/apply_with_two_key_vault_test.yml)
