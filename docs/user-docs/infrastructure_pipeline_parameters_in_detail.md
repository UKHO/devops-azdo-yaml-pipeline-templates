...
| [TerraformVersion](#terraformversion)                                         | string   |          | `'latest'`      | - `latest`<br> - valid version syntax                    |                         | Version of Terraform CLI tool to use with the terraform files.                                 |
...
| [DeploymentJobsVariableMappings](#deploymentjobsvariablemappings)             | object   |          | `{}`            | See further documentation                                | ✔                       | Variable mappings to be associated with the deployment jobs.                                   |
...
| [VerificationMode](#verificationmode)                                         | string   | ❗        |                 | - VerifyOnDestroy<br> - VerifyOnAny<br> - VerifyDisabled | ✔                       | How verification step should trigger: verify on destruction changes; on any changes; or never. |
| [TerraformEnvironmentVariableMappings](#terraformenvironmentvariablemappings) | object   |          | `{}`            | See further documentation                                | ✔                       | Environment variables to be passed to the task.                                                |
